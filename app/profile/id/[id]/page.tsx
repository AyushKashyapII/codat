...
const ProfilePageID = () => {
  ...
  const [likedCodats, setLikedCodats] = useState({});
  ...
  const handleLikeToggle = async (codatId, currentLikes) => {
    const isCurrentlyLiked = likedCodats[codatId];
    ...
    try {
      ...
      if (res.status === 200) {
        ...
        setLikedCodats((prev) => ({
          ...prev,
          [codatId]: !isCurrentlyLiked,
        }));
      }
    } catch (e) {
      console.log("error in liking/unliking ", e);
    }
  };
                        ...
                        >
                          ...
                          <div className="flex flex-col h-full justify-between">
                              ...
                              <div className="flex justify-between">
                                ...
                                <div className="flex gap-1 items-center">
                                  ...
                                  <p className="text-gray-300 text-lg">
                                    {codat.codatLikes ? codat.codatLikes : "0"}
                                  </p>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="mt-4 opacity-0 group-hover:opacity-100 transition-opacity">
                              ...
                              <button
                                className="bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded-md text-sm flex items-center"
                                onClick={() =>
                                  router.push(`/codat/${codat.codatId}`)
                                }
                              >
                                Explore{" "}
